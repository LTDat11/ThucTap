...
if (!isset($_GET['id'])) {
    header("Location: danh_sach_dich_vu.php"); // Nếu không, chuyển hướng đến trang danh sách dịch vụ
    exit();
}
...
<body>
    <div class="container">
        ...
        <form method="post">
            ...
            <a href="danh_sach_thong_tin_dich_vu.php?id=<?php echo $id; ?>" class="btn btn-secondary">Hủy</a>
        </form>
    </div>
