...
if (!isset($_GET['id'])) {
    header("Location: danh_sach_ban_hang.php");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmtUpdate->execute()) {
        ...
        header("refresh:1; url=danh_sach_thong_tin_ban_hang.php");
        exit();
    } else {
...
<body>
    <div class="container">
        ...
        <form action="sua_thong_tin_ban_hang.php?id=<?php echo htmlspecialchars($id); ?>" method="post">
            ...
            <a href="danh_sach_thong_tin_ban_hang.php" class="btn btn-secondary">Quay Lại</a>
        </form>
    </div>
