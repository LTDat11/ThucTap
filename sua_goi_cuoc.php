    ...
    <div class="container">
        ...
        <form action="sua_goi_cuoc.php?id=<?php echo htmlspecialchars($id); ?>" method="post"
            ...
            <div class="form-group">
                ...
                <img src="<?php echo $goiDichVu['ImgURL']; ?>" class="blurred" alt="Chưa có ảnh"> <br>
            ...
            <a href="chi_tiet_dich_vu.php?id=<?php echo htmlspecialchars($idDichVu); ?>" class="btn btn-secondary">Quay
                Lại</a>
        </form>
